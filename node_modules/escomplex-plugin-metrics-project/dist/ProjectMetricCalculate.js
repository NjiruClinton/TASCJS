   ...
   (0, _createClass3.default)(ProjectMetricCalculate, null, [{
      ...
      value: function calculate(projectReport, pathModule, settings) {
         ...
         if (!settings.noCoreSize) {
            var visibilityMatrix = ProjectMetricCalculate.calculateVisibilityMatrix(projectReport, adjacencyMatrix);
      ...
      value: function calculateAdjacencyMatrix(projectReport, pathModule) {
         ...
         for (var x = 0; x < length; x++) {
            for (var y = 0; y < length; y++) {
               adjacencyMatrix[x][y] = x !== y && ProjectMetricCalculate.doesDependencyExist(pathModule, modules[x], modules[y]) ? 1 : 0;
      ...
      key: 'calculateCoreSize',
      value: function calculateCoreSize(projectReport, visibilityMatrix) {
         ...
         for (var rowIndex = 0; rowIndex < length; rowIndex++) {
            if (fanIn[rowIndex] >= boundaries.fanIn && fanOut[rowIndex] >= boundaries.fanOut) {
               coreSize += 1;
            }
         }
      ...
      value: function calculateVisibilityMatrix(projectReport, adjacencyMatrix) {
         var changeCost = 0;
      ...
      value: function doesDependencyExist(pathModule, fromModuleReport, toModuleReport) {
